...
vector<double> ActualState::getFK(vector<double> vectJoint){
    ...
    joint.data = {vectJoint[0],vectJoint[1],vectJoint[2],vectJoint[3],vectJoint[4],vectJoint[5]};
...
// void ActualState::CounterCallback(const control_msgs::JointTrajectoryControllerState::ConstPtr& msg)
// {
//     posJointActual = msg->actual.positions;
//     speedJointActual = msg->actual.velocities;
//     joint_std64.data = {posJointActual[0],posJointActual[1],posJointActual[2],posJointActual[3],posJointActual[4],posJointActual[5]};
