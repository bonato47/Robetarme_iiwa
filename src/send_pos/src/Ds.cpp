...
int main(int argc, char **argv)
{
    ...
    ros::ServiceClient client_IK = Nh_.serviceClient<iiwa_tools::GetIK>("iiwa/iiwa_ik_server");
    ...
    IK_state.request.seed_angles.layout.dim.push_back(std_msgs::MultiArrayDimension());
    IK_state.request.seed_angles.layout.dim.push_back(std_msgs::MultiArrayDimension());
    IK_state.request.seed_angles.layout.dim[0].size = 1;
    IK_state.request.seed_angles.layout.dim[1].size = 7;
